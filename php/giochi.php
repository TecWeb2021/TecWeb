...
function createGameHTMLItem($game, $isAdmin=false){
	...
	$replacements = array(
		...
		"<game_sinossi_ph/>" => getStringExtract($game->getSinopsis(), 500, "gioco_scheda.php?game=".strtolower($game->getName())),
...
$param = ($gameName === null || $gameName === "") ? "" : "| Hai cercato: $gameName";
$basePage = createBasePage("../html/templates/top_and_bottomTemplate.html", "giochi", $dbAccess, $param);
